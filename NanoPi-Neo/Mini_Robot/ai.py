...
cap = pyaudio.PyAudio()
stream = cap.open(format=pyaudio.paInt16, input_device_index=4, channels=1, rate=44100, input=True,
        ...
        if (f"{SN}" in wake):
            ...
            # ~~~~~~~~~~~~~~~~~~~~ While Awake, Listen for Command: ~~~~~~~~~~~~~~~~~~~~~~~~~~
                ...
                if ("time" in query):
                    ...
                    output(f"I'm good, my Cpu is running at 1GHz, with a load of {str(psutil.cpu_percent())}%.")
                    listening = False
                    ...
                    output(
                        f"My name is {SN}, and I am an Artificial Intelligence programed by Dan's Droids for use in Robots.")
                    listening = False
